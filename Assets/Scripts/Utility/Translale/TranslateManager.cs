...
namespace YS_Tool.Translate {
    ...
    public class TranslateManager : GlobalSingletonMonoBehavior<TranslateManager> {
        ...
        public UnityEvent OnChangeTranslateLanguage {
            get { return m_OnChangeTranslateLanguage; }
        }

        public TranslateLanguage CurrentTranslateLanguage {
            get { return m_CurrentTranslateLanguage; }
        }
        ...
        public void Init(int langID) {
            ...
            if (langID != -1) {
                lang = GetLanguageFromID(langID);
            } else {
                lang = GetLanguageFromSystemLanguage(Application.systemLanguage);
            }
            ChangeTranslateLanguage(lang);
            m_IsInit = true;
        }
